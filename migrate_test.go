...
import (
	dStub "github.com/NickTaporuk/migrate/v4/database/stub"
	"github.com/NickTaporuk/migrate/v4/source"
	sStub "github.com/NickTaporuk/migrate/v4/source/stub"
)
...
func ExampleNewWithDatabaseInstance() {
	...
	// `import "github.com/NickTaporuk/migrate/v4/database/postgres"`
...
func ExampleNewWithSourceInstance() {
	...
	// `import "github.com/NickTaporuk/migrate/v4/source/stub"`
